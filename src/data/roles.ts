...
export const TAB_CATALOG: TabDef[] = [
  ...
  { tab: "crm",             label: "CRM",              group: "Finance" },
  { tab: "erp",             label: "ERP (Manufacturing)", group: "Finance" },
  { tab: "hrms",            label: "HRMS",             group: "Finance" },
  { tab: "insights",        label: "Insights",         group: "Finance" },
