  ...
  return (
    <div className="space-y-4">
      ...
      {payInvoice && (
        <RecordPaymentModal
          invoice={{
            id: payInvoice.id, invoiceNumber: payInvoice.invoice_number, customerName: payInvoice.customer_name,
            totalAmount: payInvoice.total_amount, paidAmount: payInvoice.paid_amount, creditedAmount: payInvoice.credited_amount,
          }}
          onClose={() => setPayInvoice(null)} onDone={load}
        />
      )}
    </div>
  );
