...
type PayrollTab = (typeof PAYROLL_TAB_IDS)[number];
            ...
            <div ref={slipRef} className="bg-white text-gray-900 rounded-lg border border-gray-200 p-6 max-w-2xl text-xs font-mono">
              ...
              <div className="flex items-start justify-between mb-4 pb-4 border-b border-gray-200">
                ...
                <div className="text-right">
                  <p className="font-bold text-gray-900 font-sans">{store.firm?.name || "Your Company"}</p>
                  <p className="text-gray-600">{store.firm?.gstNumber ? `GSTIN: ${store.firm.gstNumber}` : ""}</p>
                </div>
              </div>
              ...
              <p className="text-gray-400 text-[9px] mt-3 text-center">This is a computer-generated salary slip. No signature required.</p>
            </div>
          </div>
        );
      })()}
